...
echo === uruchamiam Watcher_old.ps1 ===
echo Plik: "C:\Users\adaml\OneDrive\Pulpit\GrafikWPF - projekt - GPT mods\Watcher_old.ps1"
echo SourcePath: "%SOURCE_PATH%"
echo GitExe: "%GIT_EXE%"
echo ================================

"%PS%" -ExecutionPolicy Bypass -NoProfile -NoExit -File "C:\Users\adaml\OneDrive\Pulpit\GrafikWPF - projekt - GPT mods\Watcher_old.ps1" ^
